...
void simpledb::hex_dump(const std::byte* data, size_t length, std::ostream& out, std::size_t width) {
...
std::string simpledb::hex_dump_str(const std::byte* data, size_t length, std::size_t width) {
